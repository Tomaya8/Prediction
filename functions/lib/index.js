...
exports.dailyMarketSync = exports.api = void 0;
...
// ═══════════════════════════════════════════════════════════════════════════════
exports.dailyMarketSync = functions.pubsub.schedule("every day 06:00").onRun(async () => {
    ...
    try {
        ...
        if (r.ok) {
            ...
            for (const m of markets) {
                ...
                const catMap = { Politics: "POLITICS", Sports: "SPORTS", Crypto: "CRYPTO", "Pop Culture": "ENTERTAINMENT", Science: "SCIENCE", Tech: "TECHNOLOGY", Business: "BUSINESS" };
                const category = (m.category && catMap[m.category]) || "OTHER";
                let outcomes = ["Yes", "No"];
                try {
                    outcomes = m.outcomes ? JSON.parse(m.outcomes) : outcomes;
                }
                catch (_a) { }
